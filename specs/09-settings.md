...
`.sg ss`, `.sg p`, `.sg cr`, `.sg asm`, `.sg rh` (repeat hunts, default OFF), `.sg rhmax` (repeat success cap, default 99), `.sg co`, `.sg convloop`, `.sg sal`, `.sg us`, `.sg bz`, `.sg nam`, `.sg trash`, `.sg rrg`, `.sg alias` (list / add / del item aliases), `.sg s` (show).
