...
Stand on the plot while you build. Covering only runs while someone is standing there. If clan **reserves** are still met at the other castles, the kit **stays** when you leave.
