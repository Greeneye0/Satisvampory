...
| `.s throne` then `.s 2` | **You** | ClanShare ON: numbered picker listing each plot’s servants in **chat**. Default is this castle. The in-game Choose a Servant panel stays the seat you are on (vanilla; overlay later) |
