...
| Command | Scope | What |
| --- | --- | --- |
| `.s cs` / `.s gs` | **Clan** | ClanShare on/off for **all members, all plots**. Default **OFF** (this clan may already be ON). Items move between clan castles. Sitting a clan throne lists and hunts servants from every included clan plot |
