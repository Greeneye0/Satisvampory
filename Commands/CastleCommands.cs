...
namespace Satisvampory.Commands
{
    ...
    public static class CastleCommands
    {
        ...
        public static void ShowHelp(ChatCommandContext ctx)
        {
            ...
            ctx.Reply("<color=white>YOU</color> stash/pull (dest is plot, or clan if .s cs on): <color=white>.stash</color>  <color=white>.pull plank 50</color>  <color=white>.pull seeds</color>  <color=white>.fi</color>  <color=white>.fc</color>  <color=white>.s tidy</color>  <color=white>.s ss</color>  <color=white>.s cr</color>  <color=white>.s co</color>  <color=white>.s rrglobal</color>");
        ...
        [Command(name: "rh", usage: ".s rh [all|on|off|n]", description: "List castle repeat-hunt status. .s rh all enables all. .s rh off this castle. .s rh 2 toggles that row.")]
        public static void RepeatHuntCastleCmd(ChatCommandContext ctx, string arg = null)
        {
            ...
            ctx.Reply(RepeatHunts.ChatRh(ctx.Event.SenderCharacterEntity, ctx.Event.User, arg));
        }
